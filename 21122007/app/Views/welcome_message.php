...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di Website Dawa Nazashya</h1>

        <h2>ini digunakan untuk menunjukkan kompetensi saya dalam menggunakan framework HMVC dalam pengembangan aplikassi web serta mengelola source code menggunakan sistem kontrol versi GIT</h2>
...
<section>
    ...
    <p>Halamana ini merupakan halaman selamat datang.</p>
